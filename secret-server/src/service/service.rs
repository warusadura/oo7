...
use zvariant::{Type, OwnedObjectPath};
...
impl Service {
    pub async fn open_session(&self, algorithm: String, input: String) {
        // WIP
    ...
    pub async fn set_alias(&self, name: &str, collection: OwnedObjectPath) {
        // TODO
    }
